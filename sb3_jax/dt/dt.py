...
class DT(OfflineAlgorithm):
    ...
    def train(self, gradient_steps: int, batch_size: int = 256) -> None:
        ...
        self.logger.record("train/batch_per_task", batch_size)
...
class PDT(OfflineAlgorithm):
    def __init__(
        self,
        policy: Union[str, Type[PDTPolicy]],
        env: Union[GymEnv, str],
        replay_buffer: Type[BaseBuffer] = TrajectoryBuffer,  
        learning_rate: Union[float, Schedule] = 3e-4,
        batch_size: int = 256,
